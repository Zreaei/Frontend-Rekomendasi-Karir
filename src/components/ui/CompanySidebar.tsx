      ...
      <div className="flex h-20 w-full shrink-0 items-center border-b border-white/10 px-4">
        <div className="flex w-full items-center gap-3 overflow-hidden">
          ...
          <div className={labelClass}>
            ...
            <p className="mt-0.5 text-[15px] text-white/70">Perusahaan</p>
          </div>
        </div>
      </div>

      <nav className="flex flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden px-4 pt-6" aria-label="Company navigation">
