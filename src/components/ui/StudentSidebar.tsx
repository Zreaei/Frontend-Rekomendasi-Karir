        ...
        <NavLink to="/student/job-matching" className={({ isActive }) => `${navBase} ${isActive ? navActive : ''}`}>
          {({ isActive }) => (
            <>
              ...
              <span className={`${labelClass} ${isActive ? 'text-[#0d6efd]' : 'text-[#2a2f39] group-hover:text-[#0d6efd]'}`}>Job Matching</span>
            </>
          )}
        </NavLink>
        ...
        <NavLink to="/student/job-apply" className={({ isActive }) => `${navBase} ${isActive ? navActive : ''}`}>
          {({ isActive }) => (
            <>
              ...
              <span className={`${labelClass} ${isActive ? 'text-[#0d6efd]' : 'text-[#2a2f39] group-hover:text-[#0d6efd]'}`}>Job Apply</span>
            </>
          )}
        </NavLink>
        ...
        <NavLink to="/student/competency-profile" className={({ isActive }) => `${navBase} ${isActive ? navActive : ''}`}>
          {({ isActive }) => (
            <>
              ...
              <span className={`${labelClass} ${isActive ? 'text-[#0d6efd]' : 'text-[#2a2f39] group-hover:text-[#0d6efd]'}`}>Competency Profile</span>
            </>
          )}
        </NavLink>
      </nav>
