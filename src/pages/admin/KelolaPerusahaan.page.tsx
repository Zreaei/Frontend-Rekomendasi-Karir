...
import { dummyCompanyList, dummyCompanyMetrics } from './AdminData'
...
const KelolaPerusahaan = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'pending': return <span className="inline-flex items-center justify-center w-[110px] px-3 py-1.5 bg-[#fffbeb] text-[#f59e0b] text-[10px] font-extrabold rounded uppercase tracking-wider border border-[#fde68a]">Pending</span>
      case 'terverifikasi': return <span className="inline-flex items-center justify-center w-[110px] px-3 py-1.5 bg-[#e6f9f0] text-[#10b981] text-[10px] font-extrabold rounded uppercase tracking-wider border border-[#d1f4e0]">Terverifikasi</span>
      case 'ditolak': return <span className="inline-flex items-center justify-center w-[110px] px-3 py-1.5 bg-[#fef2f2] text-[#ef4444] text-[10px] font-extrabold rounded uppercase tracking-wider border border-[#fecaca]">Ditolak</span>
      default: return <span className="inline-flex items-center justify-center w-[110px] px-3 py-1.5 bg-[#f1f4f9] text-[#7b8191] text-[10px] font-extrabold rounded uppercase tracking-wider border border-[#e4e9f4]">{status}</span>
    }
  }

  // Fungsi untuk mengambil inisial perusahaan
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
        <div className="bg-white p-6 rounded-[16px] border border-[#e4e9f4] shadow-sm flex items-start justify-between">
          <div>
            ...
            <p className="text-[32px] font-black text-[#111827]">{dummyCompanyMetrics.total}</p>
          </div>
        ...
        <div className="bg-white p-6 rounded-[16px] border border-[#e4e9f4] shadow-sm flex items-start justify-between">
          <div>
            ...
            <div className="flex items-center gap-3"><p className="text-[32px] font-black text-[#111827]">{dummyCompanyMetrics.pending}</p></div>
          </div>
        ...
        <div className="bg-white p-6 rounded-[16px] border border-[#e4e9f4] shadow-sm flex items-start justify-between">
          <div>
            ...
            <div className="flex items-center gap-3"><p className="text-[32px] font-black text-[#111827]">{dummyCompanyMetrics.verified}</p></div>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#f8faff] border-y border-[#e4e9f4] text-[10px] font-extrabold text-[#7b8191] uppercase tracking-widest">
                  <th className="px-6 py-4 whitespace-nowrap">Perusahaan</th>
                  <th className="px-6 py-4 whitespace-nowrap">Data Registrasi</th>
                  <th className="px-6 py-4 whitespace-nowrap">Dokumen</th>
